...
type Model = {
    ...
    RegionToBeRendered  : BoundingBox
    OverallBBoxToBeRendered : BoundingBox
...
type Msg =
    ...
    | SelectComponentsWithinRegion of BoundingBox   
...
let filterPortsMatchingHostId (portList: Symbol.Port list) (portDU : PortDU) 
...
let update (msg : Msg) (model : Model): Model*Cmd<Msg> =
    ...
    | MouseMsg mMsg ->     
        let command = 
            ...
            | Down when (mMsg.Pos.X<200. && mMsg.Pos.Y>200. && mMsg.Pos.Y<230.) -> [AddSymbol ((CommonTypes.ComponentType.BusCompare (4,uint32 (0)) ), "BC2")]      
